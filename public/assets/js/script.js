(function($) {
    ...
    function map() {
        ...
        var locations = [
            ...
            ['City inn khulna', -6.18409283840244, 106.76744958640447],
    ...
    if ($("#contact-form").length) {
        $("#contact-form").validate({
            ...
            messages: {
                name: "Silahkan input name anda",
                email: "Silahkan inut email anda",
                phone: "Silahkan inut phone anda",
                perusahaan: "Silahkan input name anda",
                lampiran: "Masukan Lampiran anda"
            },
